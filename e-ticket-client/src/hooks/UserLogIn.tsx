        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">
              Welcome to Event<span className="text-red-500">Tix</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 px-4 bg-gray-800 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors ${
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/signup" className="text-red-500 hover:text-red-700 font-medium">
                Sign up
              </Link>
            </p>
          </div>
